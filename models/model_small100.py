...
def get_language_codes():
    ref_tokenizer = M2M100Tokenizer.from_pretrained(str(persistence.get_appdata_path() / 'models' / 'small100-quantized'))
    model_codes = dict()
...
class Model:
    ...
    def __init__(self, hw, source_lang, target_lang):
        ...
        self.model = M2M100ForConditionalGeneration.from_pretrained(str(persistence.get_appdata_path() / 'models' / 'small100-quantized'))
        if hw == "cuda":
        ...
        self.tokenizer = M2M100Tokenizer.from_pretrained(str(persistence.get_appdata_path() / 'models' / 'small100-quantized'))
